...
const scriptsInEvents = {
	...
	async Game_event_Event136_Act1(runtime, localVars)
	{
	...
	async Game_event_Event137_Act3(runtime, localVars)
	{
		function onLevelComplete() {
		  ...
		  const data = {
		    ...
		    "challengeCompleted": runtime.globalVars.extraLevel,
		    "completedDate": runtime.globalVars.complition_date, // (Current Date in yyyy-mm-dd format)
		    "starsGiven":runtime.globalVars.Star, // (Total Stars The User Won)
